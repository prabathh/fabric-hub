...
export default function CartPage() {
    ...
    const couponDiscount = 45.00; // Mock saved amount
        ...
        <div className="p-6 w-full mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">                
                ...
                <div className="md:col-span-3">
                    ...
                    <h2 className="text-xl font-semibold mt-4 hidden md:block">Your Items ({cartItems.length})</h2>
                </div>

                {/* RIGHT COLUMN (1/4): Order Summary */}
                <div className="md:col-span-1 h-fit">
                    <h2 className="text-md font-semibold mb-4 uppercase">Order Summary</h2>
                    ...
                    <p className="text-sm text-red-600 font-semibold mb-4">
                        You save ${couponDiscount.toFixed(2)} ({(couponDiscount / (subtotal + couponDiscount) * 100).toFixed(0)}%)
                    </p>
                    ...
                    {/* Checkout Button */}
                    <button className="w-full py-3 bg-red-500 text-white font-bold uppercase rounded hover:bg-red-600 transition-colors">
                        Checkout
                    </button>
                </div>
            </div>
